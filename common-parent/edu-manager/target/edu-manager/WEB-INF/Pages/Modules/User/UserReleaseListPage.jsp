...
<div id="container">
    ...
    <div id="title" class="col-11 offset-1 row" style="margin-top: 50px">
        <h1>我发起的比赛</h1>
        <a href="${pageContext.request.contextPath}/user/matchRelease_page" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="margin-left: 10px">发起比赛</a>
        <br/>
        <hr/>
    </div>
