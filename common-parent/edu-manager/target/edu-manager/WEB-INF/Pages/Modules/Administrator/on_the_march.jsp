...
<header class="am-topbar am-topbar-fixed-top">
    ...
    <div class="contain">
        <ul class="am-nav am-navbar-nav am-navbar-left">
            ...
            <li><h4 class="page-title">进行中</h4></li>
        </ul>
    </div>
</header>
<!-- end page -->
                    ...
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tbody>
                                <c:forEach items="${onTheMarchMatchs}" var="match" varStatus="status">
                                    ...
                                    <td class="am-hide-sm-only">${match.releaseTime}</td>
                                        <td>
                                        ...
                                        <%--</button>--%>
                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="window.location.href='end?matchID=${match.matchID}'">
                                        <span class="am-icon-trash-o"></span> 结束
                                        </button>
                                        </div>
                                        </div>
                                        </td>
